...
public class MainController {
	...
	public String editEvent(@ModelAttribute("event")Event event,@PathVariable("id")Long id, Model viewModel, HttpSession session) {
		Long userId = (Long) session.getAttribute("userId");
	...
	public String updateEvent(@Valid @ModelAttribute("event")Event event,@PathVariable("id")Long id, Model viewModel, BindingResult result) {
		if (result.hasErrors()) {
			return "edit.jsp";
		}
